...
function buildDeck() {
	...
	//getMiniDeckThstage(greenCardsForGame, brownCardsForGame, blueCardsForGame);
}
...
function getMiniDeckFstage(greenCardsFG, brownCardsFG, blueCardsFG) {
	...
	greenCardsFG.forEach(gcard => {
		if (miniDeckFstageGreen.length < dotGreenFstage) {
			miniDeckFstageGreen.push(greenCardsFG.pop());
		}
		...
		// }
		// console.log(greenCardsFG);
		// if (miniDeckThstageGreen.length < dotGreenThstage) {
		// 	miniDeckThstageGreen.push(gcard);
		// }
...
///----Третий этап----////
// function getMiniDeckThstage(greenCardsFG, brownCardsFG, blueCardsFG) {
// 	let miniDeckThstageGreen = [];
// 	let miniDeckThstageBrown = [];
// 	let miniDeckThstageBlue = [];
// 	let miniDeckThstage = [];
// 	greenCardsFG.forEach(gcard => {
// 		if (miniDeckThstageGreen.length < dotGreenThstage) {
// 			miniDeckThstageGreen.push(gcard);
...
// 		//return greenCardsFG;
// 	});
// 	//console.log(miniDeckThstageGreen);
// }
